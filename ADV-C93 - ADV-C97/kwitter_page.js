const firebaseConfig = {
      ...
      databaseURL: "https://kwitter-9748b-default-rtdb.firebaseio.com",
...
function getData() { firebase.database().ref("/"+room_name).on('value', function(snapshot) { document.getElementById("output").innerHTML = ""; snapshot.forEach(function(childSnapshot) { childKey  = childSnapshot.key; childData = childSnapshot.val(); if(childKey != "purpose") {
         ...
         name_with_tag = "<h4>" + name + "<img class='user_tick' src='blue_tick.png'></h4>";
         message_with_tag = "<h4 class='message_h4'>" + message + "</h4>";
         like_button = "<button class='btn btn-warning' id='+firebase_message_id+' value='+like+' onclick='updateLike(this.id)'";
         span_with_tag = "<span class='glyphicon glyphicon-thumbsup'>Likes: " + like + "</span></button><hr>";
